...
<head>
  ...
  <title>FASTDROP — Быстро. Просто. Бесплатно.</title>
  ...
  <style>
    ...
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .dz.dragover{border-color:var(--s);animation:pulse 1s infinite}
    @keyframes pulse{0%,100%{transform:scale(1)}50%{transform:scale(1.02)}}
    .dz i{font-size:48px;color:var(--p);margin-bottom:12px;display:block}
    ...
    .preview-item{position:relative;overflow:hidden;border-radius:8px;box-shadow:0 4px 12px rgba(0,0,0,.3)}
    .preview-item img{width:100%;height:100px;object-fit:cover;border-radius:8px}
    .preview-name{position:absolute;bottom:0;left:0;right:0;background:rgba(0,0,0,.7);color:white;font-size:11px;padding:4px 6px;text-align:center;font-weight:500}
    ...
    .stat-icon{font-size:28px;color:var(--s);margin-bottom:8px}
    ...
    .about{text-align:center;padding:40px 20px;color:var(--tl);line-height:1.7}
    .about h2{font-size:28px;margin-bottom:20px}
    .about p{font-size:15px;max-width:700px;margin:0 auto 16px}
    .about-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:24px;margin-top:32px}
    .about-card{padding:20px;background:var(--c);border-radius:16px;text-align:center}
    .about-card i{font-size:36px;color:var(--p);margin-bottom:12px}
    .about-card h3{font-size:18px;font-weight:700;color:var(--t);margin-bottom:8px}
    .about-card p{font-size:13px;color:var(--tl)}
    ...
    @media (max-width:768px){
      .hero h1{font-size:32px}.dz{padding:36px}.dz i{font-size:40px}
...
<body>
  ...
  <main>
    <div id="home" class="tab-content active">
      ...
      <div class="stats">
        <div class="stat"><div class="stat-icon"><i class="fas fa-paper-plane"></i></div><h3><span class="count" data-target="127482">0</span></h3><p>Файлов</p></div>
        <div class="stat"><div class="stat-icon"><i class="fas fa-hdd"></i></div><h3><span class="count" data-target="89">0</span> ТБ</h3><p>Передано</p></div>
    ...
    <div id="about" class="tab-content">
      <div class="about">
        ...
        <p>Мы создали сервис, которого не хватало: быстрый, простой, без рекламы.</p>
        <p>Никаких регистраций. Никаких лимитов. Никаких ожиданий.</p>
        <div class="about-grid">
          <div class="about-card">
            <i class="fas fa-rocket"></i>
            <h3>Мгновенно</h3>
            <p>100 ГБ за 3 минуты</p>
          </div>
          <div class="about-card">
            <i class="fas fa-shield-alt"></i>
            <h3>Безопасно</h3>
            <p>Автоудаление через 7 дней</p>
          </div>
          <div class="about-card">
            <i class="fas fa-mobile-alt"></i>
            <h3>На любом устройстве</h3>
            <p>Работает как приложение</p>
          </div>
        </div>
      </div>
    </div>
...
app.listen(PORT, '0.0.0.0', () => {
  console.log('FASTDROP 15.0 — ЧЁТКО РАБОТАЕТ! http://localhost:' + PORT);
});
